...
import styles from './CreateSignalForm.module.css';
...
function CreateSignalForm({ categories, isSubmitting, submitError, onSubmit, onCancel }) {
        ...
        <form className={styles.card} onSubmit={handleSubmit} noValidate>
            <aside className={styles.intro}>
                ...
                <div className={styles.introText}>
                    <h3 className={styles.introTitle}>Подай сигнал</h3>
            ...
            <div className={styles.fields}>
                ...
                <button type="submit" className={styles.submitButton} disabled={isSubmitting}>
                    <span className={styles.submitLabel}>
                        {isSubmitting ? 'Изпращане...' : 'Изпрати сигнала'}
                    </span>
